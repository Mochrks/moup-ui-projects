...
export const SimpleFAQ = () => (
  <Accordion type="single" collapsible className="w-full">
    <AccordionItem value="item-1">
      <AccordionTrigger className="text-left font-medium">What is MoupUI?</AccordionTrigger>
      <AccordionContent className="text-muted-foreground">
        MoupUI is a comprehensive library of UI components built with React, Tailwind CSS, and
        Shadcn UI. It focuses on accessibility, performance, and clean aesthetics.
      </AccordionContent>
    </AccordionItem>
    <AccordionItem value="item-2">
      <AccordionTrigger className="text-left font-medium">Is it free to use?</AccordionTrigger>
      <AccordionContent className="text-muted-foreground">
        Yes, MoupUI is open-source and free to use for both personal and commercial projects.
      </AccordionContent>
    </AccordionItem>
    <AccordionItem value="item-3">
      <AccordionTrigger className="text-left font-medium">How do I get started?</AccordionTrigger>
      <AccordionContent className="text-muted-foreground">
...
export const CategoryFAQ = () => (
  <div className="grid md:grid-cols-2 gap-12">
    <div className="space-y-4">
      <h3 className="font-semibold text-lg pb-2 border-b">General Questions</h3>
      <SimpleFAQ />
    </div>
    <div className="space-y-4">
      <h3 className="font-semibold text-lg pb-2 border-b">Billing & Payments</h3>
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
