...
export const PulseButton: React.FC<ButtonProps> = ({ children, onClick }) => (
    <motion.button
...
export const BorderButton: React.FC<ButtonProps> = ({ children, onClick }) => (
    <motion.button
...
export const JellyButton: React.FC<ButtonProps> = ({ children, onClick }) => (
    <motion.button
...
export const GlowButton: React.FC<ButtonProps> = ({ children, onClick }) => (
    <motion.button
...
export const MorphButton: React.FC<ButtonProps> = ({ children, onClick }) => (
    <motion.button
