...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-base font-medium   dark:border-darkBorder  p-1 text-black",
      className
    )}
    {...props}
  />
