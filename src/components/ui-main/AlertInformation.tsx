  ...
  return (
    <Alert className="hidden md:block bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-white border-none">
      <div className="flex items-center justify-center">
        ...
        <div className="flex">
          <AlertDescription>
            🚧 Early Access Beta Our web component library is currently in active development.
            Expect frequent updates, potential breaking changes, and ongoing improvements.
          </AlertDescription>
        </div>
      </div>
    </Alert>
