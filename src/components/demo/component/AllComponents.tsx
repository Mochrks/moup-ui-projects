...
import {
    MessageCircleWarning, User, Star, PanelBottom,
    MessageCircleCode, LogIn, LayoutDashboard, GalleryHorizontalEnd,
    PanelLeftOpen, MessageSquareText, Loader, LayoutPanelTop,
    RectangleEllipsis, Badge, CalendarDays, BarChart3,
    SlidersHorizontal, KeySquare, Table, FormInput,
    Bell, HelpCircle, CreditCard, MessagesSquare, BookOpen,
    FileText, Map, ChevronsUpDown,
    Menu, MessageSquarePlus, ToggleLeft
} from 'lucide-react'
