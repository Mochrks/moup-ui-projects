...
const SampleComponent: React.FC = () => {
  ...
  const animations = [{ component: <ParticleBackground />, name: "Particle Network" }];
  ...
  return (
    <ContentLayout>
      <div className="p-6 text-start w-full">
        ...
        <p className="mb-4">
          Capture attention instantly with stunning animated hero sections. MoupUI provides dynamic,
          fully customizable hero components that bring your landing pages to life, seamlessly
          integrating with React, Tailwind CSS, and ShadCN UI.
        </p>

        <h3 className="text-xl font-semibold mb-4">Engaging and Interactive</h3>
        <p className="mb-4">
          Our animated hero sections feature smooth transitions and captivating animations powered
          by Framer Motion. Whether you're showcasing a product or delivering a message, these hero
          components create an immersive user experience.
        </p>

        <p className="mb-4">
          Simply copy and paste the hero template into your project, adjust the animations and
          content to suit your needs, and make a bold first impression with minimal effort.
        </p>
      </div>
