  ...
  <ContentLayout>
    <SectionDoc
      ...
      features={[
        ...
        "Multi-factor (MFA) Selection & Security Setup",
        "Account Security status screens (Success, Locked, Magic Link)",
      ]}
      dependencies={[]}
    ...
    >
      <div className="grid grid-cols-1 gap-16 md:gap-24">
        ...
        <ComponentBlock
          ...
          features={["First + last name grid", "Email field", "Password + confirm"]}
        >
        ...
        <ComponentBlock
          ...
          features={["Password visibility toggle", "Remember me switch", "Forgot password link"]}
        >
          <div className="w-full lg:w-[65%] mx-auto">
            <CodePreview
              title="Login"
        ...
        <ComponentBlock
          ...
          features={["Auto-advance inputs", "Masked identity display", "Expiry timer"]}
        >
          <div className="w-full lg:w-[65%] mx-auto">
            <CodePreview
              title="Two-Factor"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {/* MFA Selection */}
          <ComponentBlock title="MFA Selection" subtitle="Setup secondary verification method">
            <CodePreview
              title="MFA"
              code={sampleCodeAuth}
              preview={<MFASelection />}
              nameFile="mfa-selection.tsx"
            />
          </ComponentBlock>

          {/* Account Locked */}
          <ComponentBlock title="Account Locked" subtitle="Security state for failed attempts">
            <CodePreview
              title="Locked"
              code={sampleCodeAuth}
              preview={<AccountLocked />}
              nameFile="account-locked.tsx"
            />
          </ComponentBlock>

          {/* Success screen */}
          <ComponentBlock title="Join Success" subtitle="Onboarding completion screen">
            <CodePreview
              title="Success"
              code={sampleCodeAuth}
              preview={<SuccessConfirmation />}
              nameFile="success.tsx"
            />
          </ComponentBlock>

          {/* Magic Link */}
          <ComponentBlock title="Magic Link Sent" subtitle="Passwordless entry confirmation">
            <CodePreview
              title="Magic Link"
              code={sampleCodeAuth}
              preview={<MagicLinkSent />}
              nameFile="magic-link.tsx"
            />
          </ComponentBlock>
        </div>

        {/* Forgot Password */}
        <ComponentBlock title="Forgot Password" subtitle="Email reset request with hint alert">
          <div className="w-full lg:w-[65%] mx-auto">
            <CodePreview
        ...
        {/* Reset Password */}
        <ComponentBlock title="Reset Password" subtitle="New password with strength progress bar">
          <div className="w-full lg:w-[65%] mx-auto">
            <CodePreview
        ...
        {/* Social Login */}
        <ComponentBlock title="Social Login" subtitle="Google · GitHub · Discord OAuth buttons">
          <div className="w-full lg:w-[65%] mx-auto">
            <CodePreview
              title="Social Login"
