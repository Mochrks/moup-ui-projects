  ...
  return (
    <ContentLayout>
      <div className="p-6 start w-full">
        ...
        <p className="mb-4">
          Our authentication templates are designed with usability in mind, featuring clear and
          concise language, intuitive input fields, and responsive designs that adapt to any device.
          Implement our authentication components quickly and easily, customizing the design to suit
          your brand and connecting them to your authentication logic.
        </p>
      </div>
